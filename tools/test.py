...
def main():
    ...
    if args.ckpt is not None:
        ...
        assert ckpt_dir.exists(), 'checkpoint for testing does not exist'
        eval_output_dir = eval_output_dir / Path(args.ckpt).stem
    else:
    ...
    with torch.no_grad():
        if args.eval_all:
            ...
            eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, dist_test=dist_test)
