...
from ...ops.pointnet2.pointnet2_stack import pyramid_modules as pyramid_modules
...
class PyramidRoIHead(RoIHeadTemplate):
    def __init__(self, input_channels, model_cfg, num_class=1, **kwargs):
        ...
        # self.roi_grid_pool_layer = pyramid_modules.PyramidModule(
        ...
        self.roi_grid_pool_layer = pyramid_modules.SimplePyramidModule(
            input_channels = input_channels,
            nsamples = self.nsamples,
            grid_sizes = self.grid_sizes,
            num_heads = self.num_heads,
...
class PyramidRoIHeadV2(RoIHeadTemplate):
    def __init__(self, input_channels, model_cfg, num_class=1):
        ...
        self.roi_grid_pool_layer = pyramid_modules.PyramidModuleV2(
            input_channels = input_channels,
            nsamples = self.nsamples,
            grid_sizes = self.grid_sizes,
            num_heads = self.num_heads,
