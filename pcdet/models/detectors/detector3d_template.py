...
class  Detector3DTemplate(nn.Module):
    ...
    def build_backbone_2d(self, model_info_dict):
        ...
        model_info_dict['num_bev_features_2d'] = backbone_2d_module.num_bev_features
    ...
    def build_dense_head(self, model_info_dict):
        ...
        dense_head_module = dense_heads.__all__[self.model_cfg.DENSE_HEAD.NAME](
            ...
            input_channels=model_info_dict['num_bev_features_2d'],
    ...
    def forward_template(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            if post_process_cfg.NMS_CONFIG.MULTI_CLASSES_NMS:
                ...
                for cur_cls_preds, cur_label_mapping in zip(cls_preds, multihead_label_mapping):
                    ...
                    if not post_process_cfg.NMS_CONFIG.get('INTRA_HEAD_AGNOSTIC', False):
