...
def split_once_semi_data(info_paths, data_splits, root_path, labeled_ratio, logger, **kwargs):
    once_pretrain_infos = []
    once_test_infos = []
    once_labeled_infos = []
...
def split_once_semi_test_data(info_paths, data_splits, root_path, labeled_ratio, logger):
    once_test_infos = []
